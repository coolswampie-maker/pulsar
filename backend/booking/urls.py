...
from .views import (AllBusyView, AssistView, BudgetLineView, BudgetView,
                    ...
                    ProjectView, ProjectsView, RndAssistView,
...
urlpatterns = [
    ...
    path('rnd/assist/', RndAssistView.as_view(), name='rnd-assist'),
    ...
    path('profile/chat/', ProfileChatView.as_view(), name='profile-chat'),

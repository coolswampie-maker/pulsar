  ...
  function viewHome(){
    ...
    '<section class="hero2"><div class="wrap"><div class="hero2-grid">'+
      '<div class="hero2-copy">'+
        ...
        '</form>'+
        /* Только второй путь: первый уже объяснён подписью над полем,
           и повторять «опишите задачу» через две строки незачем. */
        '<p class="hero2-alt">Знаете, что ищете — <a href="#/catalog">откройте каталог</a>.</p>'+
